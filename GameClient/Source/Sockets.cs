    ...
    public class ClientInfo {
        ...
        private void ReadCallback(IAsyncResult ar) {
            try {
                ...
                ReferenceValues.CurrentModule = "Source/Modules/Menu.xaml";
                _crossViewMessenger.PushMessage("SwitchCurrentModule", null);
                ReferenceValues.IS_ALLOWED_CONNECT = true;
                MessageBox.Show("Connection to the server has been lost", "Connection Lost", MessageBoxButtons.OK, MessageBoxIcon.Error);
#if DEBUG
